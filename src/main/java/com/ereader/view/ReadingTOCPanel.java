 ...
 *
 */
public class ReadingTOCPanel extends JPanel implements NavigationEventListener {
	 ...
	 * @param navigator
	 */
	public ReadingTOCPanel(Navigator navigator) {
	...
	private void initBook(Book book) {
		...
		tree.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent me) {
				...
				navigator.gotoResource(tocItem.getTOCReference().getResource(), tocItem.getTOCReference().getFragmentId(), ReadingTOCPanel.this);
			}
		});
